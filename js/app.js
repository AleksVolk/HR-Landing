    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-slider")) new core(".main-slider", {
                ...
                navigation: {
                    prevEl: ".main-slider__arrow.slider-arrow_prev",
                    nextEl: ".main-slider__arrow.slider-arrow_next"
                },
                on: {}
            });
            if (document.querySelector(".worker-slider")) new core(".worker-slider", {
                modules: [ Navigation, Pagination ],
                speed: 800,
                spaceBetween: 30,
                pagination: {
                    el: ".worker-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".worker-slider__arrow.slider-arrow_prev",
                    nextEl: ".worker-slider__arrow.slider-arrow_next"
                },
                on: {}
            });
        }
        const createBenefitsSlider = () => {
            ...
            const benefitsSliderWrapper = document.querySelector(".benefits-slider__wrapper");
            const benefitsSliderSlide = document.querySelectorAll(".benefits-slider__slide");
            benefitsSlider.classList.add("swiper");
            benefitsSliderWrapper.classList.add("swiper-wrapper");
            benefitsSliderSlide.forEach((slide => {
                slide.classList.add("swiper-slide");
            }));
            new core(benefitsSlider, {
                modules: [ Pagination ],
                autoHeight: true,
                speed: 800,
                spaceBetween: 30,
        ...
        if (document.querySelector(".benefits-slider") && window.innerWidth < 577) createBenefitsSlider();
